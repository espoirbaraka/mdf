                ...
                <div class="block-header py-lg-4 py-3">
                    <div class="row g-3">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="m-0 fs-5"><a href="javascript:void(0);" class="btn btn-sm btn-link ps-0 btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Liste des employés en Mission</h2>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="employee_List" class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql=' SELECT  DISTINCT(email_agent), tbl_user.photo, `nom_agent`, `postnom_agent`, `prenom_agent`,`id_agent`, designation_fonction FROM tbl_affectation
