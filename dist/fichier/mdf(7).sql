...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2021 at 07:37 AM
...
(29, 3, 29, 1, '29', '2021-12-07 17:02:14', '-', NULL, '-', NULL, 'ACCEPT_AFFECTATION'),
...
(50, 29, 1, '1', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(51, 30, 1, '1', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(30, 'Media congo', 'UNPC', '', '2021-12-10 00:00:00', '2 Tables.sql', 1000, 'Goma', '0', '27', '2021-12-09 08:33:18', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL);
...
(29, 'Andre', 'safariandre66@gmail.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Scott.png', 23, NULL, '', '2021-12-08 11:44:46', NULL, NULL, NULL, NULL, '1'),
...
--
ALTER TABLE `tbl_affectation`
  MODIFY `id_affectation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `tbl_etape`
  MODIFY `id_etape` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `tbl_privilege`
  MODIFY `id_privilege` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `tbl_rapport`
  MODIFY `id_rapport` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
