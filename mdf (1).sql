...
-- Procédures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_accepterProjet` (IN `id_` INT)  BEGIN
UPDATE tbl_projet SET  statut_reussite = 1 WHERE id_projet = id_;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_archiveProjet` (IN `id_` INT)  BEGIN
UPDATE tbl_projet SET  statut_reussite = 3 WHERE id_projet = id_;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_updateProjet` (IN `id_` INT, IN `justifier` TEXT)  BEGIN
UPDATE tbl_projet SET justification = justifier, statut_reussite = 2 WHERE id_projet = id_;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_updateRapport` (IN `id_` INT, IN `text` TEXT)  BEGIN
    UPDATE tbl_rapport SET textInfo = text WHERE id_rapport = id_;
END$$
...
(12, 6, 27, 1, '27', '2021-12-06 20:34:00', '-', NULL, '-', NULL, 'ACCEPT_AFFECTATION'),
(13, 3, 27, 1, '27', '2021-12-06 20:36:54', '-', NULL, '-', NULL, 'ACCEPT_AFFECTATION'),
...
(27, 35, 27, 1, '27', '2021-12-07 15:46:13', '-', NULL, '-', NULL, 'ACCEPT_AFFECTATION'),
(28, 38, 18, 1, '18', '2021-12-07 16:43:43', '-', NULL, '-', NULL, 'ACCEPT_AFFECTATION'),
(35, 30, 27, 0, '27', '2021-12-08 17:42:10', '-', NULL, '-', NULL, 'DEMAND_AFFECTATION'),
(38, 40, 18, 1, '2021-12-08', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(39, 40, 27, 1, '2021-12-08', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(40, 48, 25, 1, '27', '2021-12-08 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(41, 48, 30, 1, '27', '2021-12-08 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(42, 48, 28, 1, '27', '2021-12-08 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(43, 48, 30, 1, '27', '2021-12-08 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(44, 50, 30, 1, '26', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(45, 50, 27, 1, '26', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(46, 50, 25, 1, '26', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(47, 50, 25, 1, '26', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(48, 51, 26, 1, '27', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(50, 36, 28, 0, '28', '2021-12-09 09:30:31', '-', NULL, '-', NULL, 'DEMAND_AFFECTATION'),
(51, 36, 28, 1, '25', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(52, 35, 33, 0, '33', '2021-12-09 09:51:54', '-', NULL, '-', NULL, 'DEMAND_AFFECTATION'),
(53, 36, 33, 1, '25', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(55, 51, 18, 1, '27', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(56, 51, 25, 1, '27', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(57, 35, 30, 1, '26', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(58, 59, 35, 1, '27', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(59, 60, 35, 1, '27', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(60, 60, 26, 1, '27', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION'),
(61, 61, 26, 1, '27', '2021-12-09 00:00:00', NULL, NULL, NULL, NULL, 'CREATE_AFFECTATION');
...
(25, 'Mumbere', 'Wasimundu', 'Wesley', 'Masculin', '', 'mumberewasimundu@gmail.com', 3, '25', '2021-12-08 00:00:00', '25', '2021-12-08 00:00:00', '-', NULL, 'EDIT_AGENT');
...
INSERT INTO `tbl_etape` (`id_etape`, `code_projet`, `code_phase`, `statut_projet`, `addBy`, `dateAdd`, `deadline`) VALUES
(3, 10, 1, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 11, 1, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 12, 1, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, 13, 1, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, 14, 1, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, 15, 1, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, 16, 1, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, 17, 1, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11, 18, 1, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(12, 19, 1, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(13, 20, 1, '0', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(17, 20, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(18, 20, 1, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(19, 20, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(20, 20, 1, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(21, 20, 3, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(22, 20, 3, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(23, 20, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(24, 20, 1, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(25, 20, 3, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(26, 16, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(27, 16, 3, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(28, 15, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(29, 14, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(30, 20, 1, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(31, 16, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(32, 16, 3, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(33, 16, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(34, 16, 3, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(35, 16, 3, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(36, 15, 3, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(37, 18, 2, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(38, 14, 3, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(39, 21, 1, '1', 25, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(40, 23, 1, '0', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(41, 25, 1, '0', 25, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(42, 11, 3, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(43, 26, 1, '1', 25, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(44, 23, 2, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(45, 23, 1, '0', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(46, 23, 1, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(47, 25, 1, '1', 2147483647, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(48, 27, 1, '1', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(49, 28, 1, '1', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(50, 29, 1, '0', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(51, 30, 1, '0', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(52, 29, 2, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(53, 29, 3, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(54, 29, 1, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(55, 29, 3, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(56, 30, 2, '0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(57, 30, 3, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(58, 29, 2, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(59, 31, 1, '1', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(60, 32, 1, '1', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(61, 33, 1, '0', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(62, 33, 2, '1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(63, 34, 1, '1', 26, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
-- Déchargement des données de la table `tbl_fichier`
--
...
(11, 'Maccabe', '2021-12-09 09:04:49', 'IMG-20210413-WA0049.jpg', 29),
(12, '', '2021-12-09 11:41:59', 'IMG-20210413-WA0036.jpg', 31),
(13, 'Base des données', '2021-12-09 12:47:15', 'mdf(5).sql', 33);
...
(5, 'w-dev', 'etongoesther@gmail.com', '', 'av rien', '25', '2021-12-09 00:00:00', '25', '2021-12-09 00:00:00', '-', NULL, 'EDIT_PARTENAIRE'),
(6, 'Wany', 'wanyranthony@gmail.com', '', 'Goma', '26', '2021-12-09 00:00:00', '-', NULL, '-', NULL, 'CREATE_PARTENAIRE'),
(7, 'PAM', 'safariandre66@gmail.com', '', 'Rutshuru', '26', '2021-12-09 00:00:00', '-', NULL, '-', NULL, 'CREATE_PARTENAIRE');
...
(16, 25, 21, '25', '2021-12-08 08:09:34', NULL, NULL, NULL, NULL, '1'),
(17, 26, 23, '26', '2021-12-08 11:36:45', NULL, NULL, NULL, NULL, '1'),
(18, 27, 25, '25', '2021-12-08 14:38:09', NULL, NULL, NULL, NULL, '1'),
(19, 25, 26, '25', '2021-12-08 15:38:55', NULL, NULL, NULL, NULL, '1'),
(20, 27, 27, '26', '2021-12-08 19:45:00', NULL, NULL, NULL, NULL, '1'),
(21, 27, 28, '26', '2021-12-08 19:45:17', NULL, NULL, NULL, NULL, '1'),
(22, 26, 29, '26', '2021-12-09 06:18:28', NULL, NULL, NULL, NULL, '1'),
(23, 27, 30, '26', '2021-12-09 06:34:10', NULL, NULL, NULL, NULL, '1'),
(24, 27, 31, '26', '2021-12-09 11:35:10', NULL, NULL, NULL, NULL, '1'),
(25, 27, 32, '26', '2021-12-09 12:38:27', NULL, NULL, NULL, NULL, '1'),
(26, 27, 33, '26', '2021-12-09 12:45:54', NULL, NULL, NULL, NULL, '1'),
(27, 27, 34, '26', '2021-12-09 12:49:47', NULL, NULL, NULL, NULL, '1');
...
INSERT INTO `tbl_projet` (`id_projet`, `titre`, `bailleur`, `objectif`, `deadline`, `file`, `budget`, `localisation`, `statut_reussite`, `addBy`, `dateAdd`, `editBy`, `dateEdit`, `deleteBy`, `deleteDate`, `statutProjet`, `validation`, `justification`) VALUES
(1, 'Enfant de la rue', 'f', '<p>vcvcv<br></p>', '0000-00-00 00:00:00', 'Main.java', 100, 'ffff', '0', '26', '2021-12-05 14:21:01', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(7, 'MSF-MWESO', 'MSF', '<p>HDHHHDHDHDHDHDHDHDHDHDHHDHDHDHDHHDHDHDHD<br></p>', '2021-12-29 00:00:00', 'CV JULIE.docx', 10000, 'Mweso', '0', '26', '2021-12-05 16:14:57', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(8, 'OXFAM-DISTRUBUTION D\'EAU', 'oxfam', 'Ce projet a pour objectif de couvrir le territoire en eau potable<br>', '2021-12-31 00:00:00', 'JULIEN PP.docx', 20000, 'Masisi', '0', '26', '2021-12-05 21:46:48', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(9, 'Paysans', 'CPDE', '<p>La realite</p>', '2021-12-29 00:00:00', 'Appel-à-manifestation-dintérêt-Facscies-Hackthon_.pdf', 1000, 'Mambasa', '0', '25', '2021-12-06 08:58:50', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(10, 'Recensement des enfants vivant dans les rues de la ville de Goma', 'UNICEF', '', '2021-12-25 00:00:00', 'KAVIRA MALEKANI Shekinah.doc', 100, 'RDC/nord-kivu/Goma/commune de Goma', '2', '18', '2021-12-06 09:34:26', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, 'Pas de document'),
(11, 'Recensement des enfants vivant dans les rues de la ville de Bukavu', 'UN', '', '2021-12-17 00:00:00', 'KAVIRA MALEKANI Shekinah.doc', 200, 'RDC/nord-kivu/Bukavu', '1', '18', '2021-12-06 10:10:43', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(12, 'Evacuation immondices', 'WFP', '<p>BON<br></p>', '2021-12-23 00:00:00', '', 455, 'GOMA', '0', '29', '2021-12-06 10:46:46', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(13, 'epst', 'epst-rdc', '<p><font style=\"vertical-align: inherit;\"><font style=\"vertical-align: inherit;\">ce projet a pour but de faire le recensement de tous les enseignants congolais</font></font></p>', '2021-11-12 00:00:00', 'KAVIRA MALEKANI Shekinah.doc', 900, 'RDC/nord-kivu/Bukavu', '1', '18', '2021-12-06 12:00:46', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(14, 'Hackaton ISIG-MDF 2000', 'MDF/ISIG', 'Automatisation de MDF', '2021-12-09 00:00:00', '5pt2jhqu.csv', 2000, 'Nord-Kivu/Goma/Isig-Goma', '1', '27', '2021-12-06 12:08:21', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(15, 'Enfant orphelin', 'UNICEF', '<p>Prendre en charge</p>', '2021-12-30 00:00:00', 'Appel-à-manifestation-dintérêt-Facscies-Hackthon_.pdf', 10000, '', '1', '25', '2021-12-06 12:43:43', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(16, 'Distribution d\'eau dans la ville de goma', 'MERCY-CORPS', '<p><br></p>', '2021-12-14 00:00:00', '', 10000, 'GOMA', '1', '26', '2021-12-06 12:44:55', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(17, 'HEAL-AFRICA', 'HEAL-AFRICA', '<p><u><b>Sante de la popolation des villes</b></u></p><ol><li>Goma</li><li><u><b>Bukavu<br></b></u><br></li></ol>', '2021-12-16 00:00:00', '', 1000, 'GOMA', '0', '29', '2021-12-06 13:31:12', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(18, 'Hopital General', 'GOUVERNEMENT PROVINCIAL', '<p><b>Objectif</b></p><p><b>1. </b>Sante de la population<b><br></b><br></p>', '2021-12-14 00:00:00', '', 10000, 'Goma', '0', '26', '2021-12-06 13:34:53', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(19, 'Femme viole', 'UN', '<p>Humanite</p>', '2021-12-23 00:00:00', 'Appel-à-manifestation-dintérêt-Facscies-Hackthon_.pdf', 10000, '', '3', '25', '2021-12-06 14:04:06', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(20, 'Kivu developpment', 'ISIG-GOMA', '<p>Voici l\'objectif du projet<br></p>', '2021-12-31 00:00:00', 'CV JULIE(1).docx', 10000, 'Goma', '0', '26', '2021-12-07 09:21:37', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(21, 'Durable', 'CDPE', '<p>absolu</p>', '2021-12-10 00:00:00', '2021.11_Theatre_Il a pris le relais_21.11.2021 + Nadine.docx', 1000, 'Mambasa', '2', '25', '2021-12-08 09:54:43', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, 'abscence'),
(22, 'Durable fond', 'social', 'kdajknjnsfjkndsjknfjdnf', '2021-12-17 00:00:00', '2021.11_Theatre_Il a pris le relais_21.11.2021 + Nadine.docx', 1000, 'Mambasa', '0', '25', '2021-12-08 10:57:02', '-', NULL, '-', NULL, 'CREATE_PROJECT', 0, NULL),
(23, 'MONUSCO-RDC', 'UN', '<p>Monusco pour les nations unis<br></p>', '2021-12-31 00:00:00', 'mdf(5).sql', 100000, 'Goma', '1', '26', '2021-12-08 13:36:01', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(24, 'ISC Inscription', 'ISC', '', '2021-12-25 00:00:00', 'mdf(4).sql', 5000, 'Goma', '0', '26', '2021-12-08 13:54:04', '-', NULL, '-', NULL, 'CREATE_PROJECT', 0, NULL),
(25, 'Virunga Energies', 'PNVi', '<p>Mise en place du borne fontaine de Mutwanga et ses environs</p>', '2021-12-31 00:00:00', '47F7B52F-516C-47CE-A2F5-2E0663C9D30AL0001.jpeg', 10000, 'Mutwanga', '1', '27', '2021-12-08 16:36:59', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(26, 'Hackaton ISIG-MDF 2001', 'MDF/ISIG', '<p>utile</p>', '2021-12-09 00:00:00', '2AA73CC2-6110-4FB1-B9A2-1676D3D17F54L0001.jpeg', 1000, 'Mutwanga', '0', '25', '2021-12-08 17:33:22', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(27, 'ISIG-UCB', 'MDF', 'Hachaton 2021<br>', '2021-12-09 00:00:00', 'mdf(5).sql', 2000, 'Goma', '0', '27', '2021-12-08 21:43:14', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(28, 'Msf-mushaki', 'MSF', '<p>la sante de la popolation<br></p>', '2021-12-10 00:00:00', 'mdf(5).sql', 1000, 'Goma', '0', '27', '2021-12-08 21:44:38', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(29, 'JOIN ISIG', 'ISIG-GOMA', '<p>FFF<br></p>', '2021-12-10 00:00:00', 'mdf(5).sql', 1000, 'Goma', '1', '26', '2021-12-09 08:18:12', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(30, 'Media congo', 'UNPC', '', '2021-12-10 00:00:00', '2 Tables.sql', 1000, 'Goma', '1', '27', '2021-12-09 08:33:18', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(31, 'Aide Humanitaire', 'MDF/ISIG', '<p>Aide</p>', '2021-12-31 00:00:00', '', 1000, 'Mutwanga', '1', '27', '2021-12-09 13:34:48', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(32, 'Goma ', 'PNVi', '<p>Voir</p>', '2021-12-31 00:00:00', '', 1000, 'Nord-Kivu/Goma/Isig-Goma', '1', '27', '2021-12-09 14:38:05', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(33, 'PROJET MDF-RDC', 'MDF', '', '2021-12-17 00:00:00', 'mdf(7).sql', 1000, 'Goma', '1', '27', '2021-12-09 14:45:18', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL),
(34, 'PROJET MONUSCO', 'MONUSCO', '', '2021-12-16 00:00:00', '', 1000, 'Goma', '0', '27', '2021-12-09 14:49:12', '-', NULL, '-', NULL, 'CREATE_PROJECT', 1, NULL);
...
--
-- Déchargement des données de la table `tbl_rapport`
--
...
INSERT INTO `tbl_rapport` (`id_rapport`, `textInfo`, `fichier`, `code_affectation`, `addBy`, `dateAdd`) VALUES
(2, '                                                                                                                <p class=\"MsoNormal\" style=\"margin: 0in 0in 7.95pt; text-indent: 0in; line-height: 116%;\" align=\"left\"><span lang=\"FR\">Il est demandé\r\ndans un temps limité de répondre au défi de gestion d’acquisitions de MDF-AC\r\nqui est de <b>« Digitaliser et centraliser\r\nla gestion collaborative dans le processus d’acquisition de marché,\r\nd’élaboration de proposition jusqu’à la mise en  œuvre &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; du &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; projet/mission &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; »</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; en &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; présentant &nbsp;&nbsp;&nbsp; des prototypes/applications/plateformes de différentes\r\nfonctionnalités et répondant à ces use-cases : <o:p></o:p></span></p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:-.65pt;margin-bottom:\r\n.15pt;margin-left:3.1pt;line-height:115%\"><b><span lang=\"FR\">Case-1 : </span></b><span lang=\"FR\">Intégration des utilisateurs </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(administrateur, manager et user) </span><span lang=\"FR\">dans la plateforme </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(conception d’un module de création de\r\ncompte des utilisateurs – le staff MDF-AC)</span><span style=\"color:#00B050;mso-ansi-language:FR\" lang=\"FR\"> </span><span lang=\"FR\">et attribution des privilèges/rôles </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(gestion des utilisateurs,\r\ngestion de missions/projets crées, création de missions/projet, gestion des\r\nresponsabilités/ tâches) </span><span lang=\"FR\">; <o:p></o:p></span></p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:0in;margin-bottom:.5pt;\r\nmargin-left:-.25pt\"><b><span lang=\"FR\">Case-2 : </span></b><span lang=\"FR\">Création du canal (équipe) de projet en y mettant\r\ntoutes les informations relatives au projet </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(Titre, bailleur de fond, deadline,\r\nobjectifs, budget, localisation, etc.) </span><span lang=\"FR\">; <o:p></o:p></span></p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:-.65pt;margin-bottom:\r\n.15pt;margin-left:3.1pt;line-height:115%\"><b><span lang=\"FR\">Case-3 : </span></b><span lang=\"FR\">Adhésion des utilisateurs au canal </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(demande d’adhésion et\r\napprobation de la demande par le manager ou le créateur du canal) </span><span lang=\"FR\">; <o:p></o:p></span></p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:0in;margin-bottom:.5pt;\r\nmargin-left:-.25pt\"><b><span lang=\"FR\">Case-4 : </span></b><span lang=\"FR\">Planification des responsabilités/ tâches </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(workflow) </span><span lang=\"FR\">avec des deadlines dans le calendrier partagé ; <o:p></o:p></span></p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:-.65pt;margin-bottom:\r\n.15pt;margin-left:3.1pt;line-height:115%\"><b><span lang=\"FR\">Case-5.a : </span></b><span lang=\"FR\">Rédaction commune du projet </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(un fichier doc partagé ou un éditeur\r\nWYSIWYG intégré) </span><span lang=\"FR\">; <o:p></o:p></span></p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:-.65pt;margin-bottom:\r\n.15pt;margin-left:3.1pt;line-height:115%\"><b><span lang=\"FR\">Case-5.b : </span></b><span lang=\"FR\">Rédaction partagé du projet </span><span style=\"color:red;mso-ansi-language:FR\" lang=\"FR\">(attribution des responsabilités/tâches\r\nau niveau de la rédaction de la proposition) </span><span lang=\"FR\">; <o:p></o:p></span></p><p>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n</p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:0in;margin-bottom:277.9pt;\r\nmargin-left:-.25pt\"><b><span lang=\"FR\">Case-6 :</span></b><span lang=\"FR\"> Recherche des informations dans les métadonnées de la plateforme en\r\nrespectant le niveau d’accès. </span></p><p class=\"MsoNormal\" style=\"margin-top:0in;margin-right:0in;margin-bottom:277.9pt;\r\nmargin-left:-.25pt\"><span lang=\"FR\">option<br></span></p>\r\n\r\n                                                    \r\n\r\n                                                    ', '99626E74-667D-4F19-A96B-0251C9209F4EL0001.jpeg', 4, '27', '2021-12-07 13:16:54'),
...
(13, '<p>Bonjour monsieur l\'admin<br></p>', '2 Tables.sql', 27, '27', '2021-12-07 21:02:14'),
(14, '<p>ooookkkk<br></p>', '', 27, '27', '2021-12-07 21:02:58'),
(15, '', '', 27, '27', '2021-12-08 09:25:32'),
(16, '                                                        <p>Merci pour l\'ajout dans le canal<br></p>\r\n\r\n                                                    ', '', 44, '30', '2021-12-09 08:21:39'),
(17, '                                                        <p>Merci aussi mon bro <br></p>\r\n\r\n                                                    ', '', 45, '27', '2021-12-09 08:22:38'),
(18, '<p>tu es sublime</p>', '', 51, '28', '2021-12-09 09:36:32'),
(19, '<p>merci beaucoup</p>', '', 53, '33', '2021-12-09 09:53:22'),
(20, '                                                        <p>wende esclave you ndeke, you mafuzy edende</p>\r\n\r\n                                                    ', '', 54, '34', '2021-12-09 10:00:33'),
(21, '<p>Budget</p>', '', 59, '35', '2021-12-09 14:40:13');
...
(26, 'Espoir', 'esbarakabigega@gmail.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'IMG_20210107_181859101.jpg', 19, NULL, '', '2021-12-08 11:23:38', NULL, NULL, NULL, NULL, '1'),
...
(30, 'Shekinah', 'shekinahmalekani@icloud.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', '', NULL, 4, '', '2021-12-07 18:59:06', NULL, NULL, NULL, NULL, '2'),
(33, 'w-dev', 'etongoesther@gmail.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', '', NULL, 5, '', '2021-12-09 07:51:18', NULL, NULL, NULL, NULL, '2'),
(35, 'PAM', 'safariandre66@gmail.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', '', NULL, 7, '', '2021-12-09 11:23:35', NULL, NULL, NULL, NULL, '2');
...
--
-- Index pour la table `tbl_detailprojet`
--
...
--
-- Index pour la table `tbl_fonction`
--
ALTER TABLE `tbl_fonction`
  ADD PRIMARY KEY (`id_fonction`);

--
-- Index pour la table `tbl_partenaire`
--
...
--
-- Index pour la table `tbl_phase`
--
ALTER TABLE `tbl_phase`
  ADD PRIMARY KEY (`id_phase`);

--
-- Index pour la table `tbl_privilege`
--
...
--
-- Index pour la table `tbl_projet`
--
ALTER TABLE `tbl_projet`
  ADD PRIMARY KEY (`id_projet`);

--
-- Index pour la table `tbl_rapport`
--
...
--
-- Index pour la table `tbl_rapport_complet`
--
...
--
-- Index pour la table `tbl_telephone`
--
...
--
ALTER TABLE `tbl_affectation`
  MODIFY `id_affectation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT pour la table `tbl_agent`
--
ALTER TABLE `tbl_agent`
  MODIFY `id_agent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT pour la table `tbl_detailprojet`
--
ALTER TABLE `tbl_detailprojet`
  MODIFY `id_detail` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `tbl_etape`
--
ALTER TABLE `tbl_etape`
  MODIFY `id_etape` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT pour la table `tbl_fichier`
--
ALTER TABLE `tbl_fichier`
  MODIFY `id_fichier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT pour la table `tbl_fonction`
--
ALTER TABLE `tbl_fonction`
  MODIFY `id_fonction` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `tbl_partenaire`
--
ALTER TABLE `tbl_partenaire`
  MODIFY `id_partenaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `tbl_phase`
--
ALTER TABLE `tbl_phase`
  MODIFY `id_phase` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `tbl_privilege`
--
ALTER TABLE `tbl_privilege`
  MODIFY `id_privilege` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT pour la table `tbl_projet`
--
ALTER TABLE `tbl_projet`
  MODIFY `id_projet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT pour la table `tbl_rapport`
--
ALTER TABLE `tbl_rapport`
  MODIFY `id_rapport` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT pour la table `tbl_rapport_complet`
--
ALTER TABLE `tbl_rapport_complet`
  MODIFY `id_Rapport_c` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `tbl_telephone`
--
ALTER TABLE `tbl_telephone`
